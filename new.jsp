...
"width="50"height="50"></td><input type="checkbox" value="水笔" name="item">&nbsp; 水笔   <td>￥5000</td>        </p>
    <p>
        &nbsp;
...
"width="50"height="50"></td><input type="checkbox" value="铅笔" name="item">&nbsp;
    铅笔<td>￥5000</td>
    </p>
    <p>
        &nbsp;
...
"width="50"height="50"></td><input type="checkbox" value="彩笔" name="item">
    彩笔 <td>￥5000</td>
    </p>
    <p>
